...
いろちがいポケモンの入手状況を2人で共有するGoogle Apps Script(GAS)アプリ<br>
...
上記の設計のスプレッドシートをデータベースとして使用しています。なお、上記はデータベースのサンプルであり、GASのコードは付属しておりません。<br>

### 各シート（テーブル）の説明

<details><summary>各シート（テーブル）の詳細はコチラ</summary>
  <div>
